...
export const PLAYERS = [
  { id: 1,  name: 'Alon Berla',      username: 'alon_b',   email: 'alon@hevre.app',   position: 'CAM', rating: 8.6, goals: 24, assists: 18, cleanSheets: 0,  gamesPlayed: 28, neighborhood: 'Ramat Gan',      paid: true,  role: ROLES.ORGANIZER, bio: "Grew up playing in Ramat Gan streets. Addicted to the through-ball. If you make the run, I'll find you." },
  { id: 2,  name: 'Ilia Simhovich',  username: 'ilia_s',   email: 'ilia@hevre.app',   position: 'GK',  rating: 8.1, goals: 0,  assists: 2,  cleanSheets: 14, gamesPlayed: 26, neighborhood: 'Tel Aviv',         paid: true,  role: ROLES.ORGANIZER, bio: "Last line of defense. Played in the youth academy, now keeping it clean in the neighborhood. Shout at me if the wall's wrong." },
  { id: 3,  name: 'Yoel Kraitman',   username: 'yoel_k',   email: 'yoel@hevre.app',   position: 'ST',  rating: 8.4, goals: 31, assists: 8,  cleanSheets: 0,  gamesPlayed: 30, neighborhood: 'Givatayim',        paid: false, role: ROLES.ORGANIZER, bio: "I score. That's it. Ask the defenders." },
  ...
  { id: 6,  name: 'Omer Katz',       username: 'omer_k',   email: 'omer@hevre.app',   position: 'CM',  rating: 7.6, goals: 5,  assists: 11, cleanSheets: 0,  gamesPlayed: 22, neighborhood: 'Petah Tikva',      paid: true,  role: ROLES.ORGANIZER },
  ...
  { id: 9,  name: 'Lior Mizrahi',    username: 'lior_m',   email: 'lior@hevre.app',   position: 'CDM', rating: 7.5, goals: 3,  assists: 7,  cleanSheets: 0,  gamesPlayed: 21, neighborhood: 'Bnei Brak',        paid: true,  role: ROLES.ORGANIZER },
  ...
  { id: 12, name: 'Niv Israeli',     username: 'niv_i',    email: 'niv@hevre.app',    position: 'CF',  rating: 7.8, goals: 16, assists: 7,  cleanSheets: 0,  gamesPlayed: 23, neighborhood: 'Holon',            paid: false, role: ROLES.ORGANIZER },
  ...
  { id: 14, name: 'Shay Bar',        username: 'shay_b',   email: 'shay@hevre.app',   position: 'CM',  rating: 7.9, goals: 7,  assists: 13, cleanSheets: 0,  gamesPlayed: 25, neighborhood: 'Tel Aviv',         paid: true,  role: ROLES.ORGANIZER },
  ...
  { id: 16, name: 'Matan Cohen',     username: 'matan_c',  email: 'matan@hevre.app',  position: 'RW',  rating: 8.1, goals: 14, assists: 10, cleanSheets: 0,  gamesPlayed: 24, neighborhood: 'Ramat Gan',        paid: true,  role: ROLES.ORGANIZER, bio: "Fast, clinical, always on the right side. Ramat Gan's finest winger — ask anyone who's tried to track me." },
  ...
  { id: 19, name: 'Ofir Klein',      username: 'ofir_k',   email: 'ofir@hevre.app',   position: 'LB',  rating: 7.5, goals: 3,  assists: 6,  cleanSheets: 0,  gamesPlayed: 22, neighborhood: 'Rishon LeZion',    paid: false, role: ROLES.ORGANIZER },
  { id: 20, name: 'Yair Solomon',    username: 'yair_s',   email: 'yair@hevre.app',   position: 'CAM', rating: 8.2, goals: 20, assists: 16, cleanSheets: 0,  gamesPlayed: 27, neighborhood: 'Tel Aviv',         paid: true,  role: ROLES.ORGANIZER },
  ...
  { id: 22, name: 'Ran Elias',       username: 'ran_e',    email: 'ran@hevre.app',    position: 'CM',  rating: 7.7, goals: 6,  assists: 12, cleanSheets: 0,  gamesPlayed: 23, neighborhood: 'Herzliya',         paid: true,  role: ROLES.ORGANIZER },
  ...
  { id: 31, name: 'Gal Hadari',      username: 'gal_h',    email: 'gal@hevre.app',    position: 'CM',  rating: 8.1, goals: 10, assists: 15, cleanSheets: 0,  gamesPlayed: 27, neighborhood: 'Herzliya',         paid: true,  role: ROLES.MUNICIPALITY_ADMIN, bio: "Engine of the midfield. I cover every blade of grass so the attackers can do their thing. Unsung hero? Fine by me." },
